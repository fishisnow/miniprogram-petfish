export default {
  ...
  card: {
    url: 'https://img.fishisnow.xyz/fish/三线铅笔灯.jpg',
    desc: '三线铅笔灯',
    info: {
  ...
  detail: {
    ...
    description: '体长4cm左右，具有三条横向黑带（上及中线较粗，腹部下线较细），各鳍均带红色斑纹。吻部至尾鳍前有连续黑带，胸斑和上唇呈鲜艳红色。',
    careGuide: {
      waterParameters: {
        temperature: '24-28℃',  
        pH: '5.5-7.0',          
    ...
    breedingInfo: {         
      ...
      specialRequirements: '需密集水草或莫斯作为产卵床，弱光环境'
    }
  }
}