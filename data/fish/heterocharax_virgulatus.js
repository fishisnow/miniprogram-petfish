export default {
  ...
  card: {
    url: '/images/fish/二线水晶灯.jpg',
    desc: '二线水晶灯',
    info: {
      habitat: '塔巴荷斯水系及内格罗上游 → 温度24-28℃/弱酸性软水', 
      tips: '健康个体饲养难度不高 → 建议每10升水饲养3-4条'
    },
    tags: ['新手友好', '群游性', '小型鱼']
  },
  detail: {
    name: '二线水晶灯',
    scientificName: 'Heterocharax virgulatus',
    description: [
      '具有标志性的黑色巨目和晶莹体色',
      '体侧两条翠绿色亮线：上线位于身体中央，下线从腹部延伸至臀鳍末端',
      '鱼腹部位呈现翠绿光彩',
      '雌雄异形：雌鱼体型较大(约5cm)，雄鱼较小(4.5cm以下)'
    ],
    careGuide: {
      waterParameters: {
        temperature: '24-28℃',  
